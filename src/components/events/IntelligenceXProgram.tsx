      ...
      { time: "12:30–13:30", tracks: [{ type: "lunch", title: "Lunch" }] },
      {
        ...
        tracks: [
          ...
          },
          {
            ...
            speakers: [
              { name: "Hoang Vu (UCSB)", detail: "A Probabilistic Representation for Multi-State Discrete-Time Quantum Walks" },
              { name: "Ege Yilmaz (U Basel)", detail: "Operating Regimes for Scalable Quantum Reservoir Learning" },
              { name: "Ariel Neufeld (NUS)", detail: "Quantum Monte Carlo algorithm for option pricing and its complexity analysis" },
              { name: "Josef Teichmann (ETHZ)", detail: "A universality result in Quantum Reservoir Computing" },
            ],
          },
        ],
      },
